#ifndef INERTIAL_FRONTEND_PREINTEGRATED_IMU_MEASUREMENT_HPP_
#define INERTIAL_FRONTEND_PREINTEGRATED_IMU_MEASUREMENT_HPP_
...
#endif  // INERTIAL_FRONTEND_PREINTEGRATED_IMU_MEASUREMENT_HPP_
